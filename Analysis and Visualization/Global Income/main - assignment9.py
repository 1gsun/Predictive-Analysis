...
print(income_head)
income_head.to_csv("Output/Q3 - Income Head.csv")
...
while True:
    try:
        input_year = input("Which year do you want to plot of income per person? Or type continue: ")
        if input_year.upper() == str("CONTINUE"):
            break
        try:
...
year_generate = [2011,2012]

print("Plotting 2011,2012...")
